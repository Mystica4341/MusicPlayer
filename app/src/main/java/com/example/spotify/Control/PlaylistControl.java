...
public class PlaylistControl extends SQLiteOpenHelper {
    ...
    public PlaylistControl(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public ArrayList<PlayList> loadData(){
        ...
        do {
            ...
            pL.setId(cursor.getString(0));
            pL.setName(cursor.getString(1));
            pL.setArtist(cursor.getString(2));
            pL.setDuration(cursor.getInt(3));
            pL.setMusicURL(Uri.parse(cursor.getString(4)));
            pL.setImageMusic(Uri.parse(cursor.getString(5)));
            result.add(pL);
